...
class MediaAttachment < ApplicationRecord
  ...
  # We set this attribute before post-processing when
  # a new file is being uploaded, that's when we perform
  # a real check on whether the file has got artwork in
  # it or not. After that, the metadata of the artwork
  # is saved permanently so we can use it as a shortcut.
  def audio_with_art?
    @audio_with_art ||= file.meta&.key?('small')
  end
